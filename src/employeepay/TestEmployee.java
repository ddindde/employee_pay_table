...
public class TestEmployee {
	...
	public static void main(String[] args) {
		...
		// 7. switch(no) {
		// 8. case 1 : Staff 클래스적용
		// 입력은 string 직책 title,  long 급여 staffpay, 변수 
		// Staff sa = new Staff(name, no, ,title, staffpay)
		//emp[i] = sa;
		//break;
		 switch(eno) {
		 case 1 : 
			 ...
			 sa.setStaffpay(staffpay);
			 emp[i] = sa;
			 break;
			 
			 // 9. case 2 : RegEmployee 클래스적용
			 //10. case 3 : TempEmployee 클래스적용
			 //11.   default: 
		...
		// 급여보고서
		// 향상 된 for(데이터타입 변수 : 배열 emp) {
		// System.out.print(변수 + "급여액:" +변수.earning()+"만원"}
